# SPL-01
**PROJECT DESCRIPTION**
>>This Linux based project takes directory path as input and accesses all the files of that directory and prints metadata of all the files. If any 2 files are found duplicate (meta data are same) then any one of them will be deleted. Simulataneously it will also print text similarity between 2 files for all the files of that directory and will express it through a matrix <<
